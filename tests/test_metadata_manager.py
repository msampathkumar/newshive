"""
Tests for the updated MetadataManager — blog_sources and blog_articles tables.
"""
import pytest
import sqlite_utils
from newshive.metadata_manager import MetadataManager, STATUS_DOWNLOADED, STATUS_EXTRACTED


@pytest.fixture
def db(tmp_path):
    return MetadataManager(db_path=tmp_path / "test.db")
